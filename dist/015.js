...
function handleGuestChange(originalList, guestThatCantMakeIt, newGuest) {
...
const guestThatCantMakeIt = "Albert Einstein";
const newGuest = "Marie Curie"; // New guest to invite
